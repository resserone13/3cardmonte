...
class GameOver(Scene):
	...
	def touch_began(self, touch):
		if touch.location in self.new_game.frame:
			...
			self.main.card_pos_1.run_action(A.fade_to(1, 1.5))
			self.main.card_pos_2.run_action(A.fade_to(1, 1.5))		
			self.main.card_pos_3.run_action(A.fade_to(1, 1.5))	
			self.main.main_node.run_action(A.fade_to(1, 1.5))
...
class Main(Scene):
	def setup(self):
		...
		for bb in (self.size.w * .11, self.size.h * 0.55), (self.size.w * .11, self.size.h * 0.35):
	...
	def wooden_border(self):
		...
		for location in (self.size.w * 0.015, self.size.h * 0.015), (self.size.w * 0.015, self.size.h * 0.96), (self.size.w * 0.985, self.size.h * 0.98), (self.size.w * 1.003, self.size.h * .000):
			bl_wood = SpriteNode(
				'plc:Wood_Block', 
				parent=b_border)
